...
const Data = () => {
  return (
    <div className="home_data">
        <h1 className="home_title">Mohammad Raphe <svg
                  width="36"
                  height="36"
                  viewBox="0 0 48 48"
                  fill="none"
        ...
        <p className="home_description">I'm driven by a deep passion for problem-solving and the exciting world of software engineering.</p>
